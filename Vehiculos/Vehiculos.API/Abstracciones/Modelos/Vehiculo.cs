...
namespace Abstracciones.Models
{
    public class VehiculoBase
    {
        ...
        [RegularExpression(@"^[A-Za-z]{3}-[1-9]{3}", ErrorMessage = "La placa debe tener el formato ABC-123")]
        public string Placa { get; set; }

        [Required(ErrorMessage = "La propiedad color es requerida")]
        [StringLength(40, ErrorMessage = "La propiedad color debe ser mayor a 4 caracteres y menor a 40")]
        public string Color { get; set; }

        [Required(ErrorMessage = "La propiedad año es requerida")]
        [RegularExpression(@"^\d{4}$", ErrorMessage = "El formato del año no es válido")]
